...
# $func1010
# ==========================================================
def func1010(var0, var1, var2, var3, var4, var5, var6, var7, var8):
    var9 = 0
    var10 = 0
    var11 = 0
    var12 = 0
    ...
    if var0:
        ...
        i32_store8(var6 + 2, ((((((((var11 * 19077) & 0xFFFFFFFF) >> 8) + (((((((((var13 | (var10 << 16)) + ((var14 | (var12 << 16)) * 3)) + 131074) & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var9 < 16384 else 0) else (255 if (1 if var16 >= 17685 else 0) else 0)))
        ...
        i32_store8(var6, (((((var11 + ((((((var12 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var9 < 16384 else 0) else (255 if (1 if var16 >= 14234 else 0) else 0)))
        ...
        i32_store8(var6 + 1, (((((var11 - ((((var14 * 6419) & 0xFFFFFFFF) >> 8) + (((var12 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var12 < 16384 else 0) else (255 if (1 if var11 >= -8708 else 0) else 0)))
        if var1:
            ...
            i32_store8(var7 + 2, ((((((((var11 * 19077) & 0xFFFFFFFF) >> 8) + ((((((((var10 + (var13 * 3)) + 131074) & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var9 < 16384 else 0) else (255 if (1 if var16 >= 17685 else 0) else 0)))
            var12 = (((var12 & 0xFFFFFFFF) >> 18) & 255)
            var16 = (var11 + ((((((var12 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8))
            var9 = ((var11 + ((((((var12 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234)
            i32_store8(var7, (((((var11 + ((((((var12 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var9 < 16384 else 0) else (255 if (1 if var16 >= 14234 else 0) else 0)))
            var11 = (var11 - ((((var14 * 6419) & 0xFFFFFFFF) >> 8) + (((var12 * 13320) & 0xFFFFFFFF) >> 8)))
            var12 = ((var11 - ((((var14 * 6419) & 0xFFFFFFFF) >> 8) + (((var12 * 13320) & 0xFFFFFFFF) >> 8))) + 8708)
            i32_store8(var7 + 1, (((((var11 - ((((var14 * 6419) & 0xFFFFFFFF) >> 8) + (((var12 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var12 < 16384 else 0) else (255 if (1 if var11 >= -8708 else 0) else 0)))
        var16 = (var8 - 1)
        ...
        while True:  # loop $label1
            ...
            i32_store8(var9 + 2, ((((((((var11 * 19077) & 0xFFFFFFFF) >> 8) + (((((((((((((var17 | (var19 << 16)) + (((var12 | (var22 << 16)) + var13) + var10)) + 524296) + (var22 << 1)) & 0xFFFFFFFF) >> 3) + var10) & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var24 < 16384 else 0) else (255 if (1 if var20 >= 17685 else 0) else 0)))
            ...
            i32_store8(var9, (((((((((((var19 & 0xFFFFFFFF) >> 17) & 255) * 26149) & 0xFFFFFFFF) >> 8) + var15) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var24 < 16384 else 0) else (255 if (1 if var20 >= 14234 else 0) else 0)))
            ...
            i32_store8(var9 + 1, (((((var15 - ((((var19 * 13320) & 0xFFFFFFFF) >> 8) + (((var23 * 6419) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var15 < 16384 else 0) else (255 if (1 if var9 >= -8708 else 0) else 0)))
            ...
            i32_store8(var9 + 2, ((((((((var15 * 19077) & 0xFFFFFFFF) >> 8) + ((((((((((var17 + ((var10 + var11) << 1)) & 0xFFFFFFFF) >> 3) + var12) & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var24 < 16384 else 0) else (255 if (1 if var20 >= 17685 else 0) else 0)))
            ...
            i32_store8(var9 + 1, (((((var15 - (((((((var10 & 0xFFFFFFFF) >> 17) & 255) * 13320) & 0xFFFFFFFF) >> 8) + (((var23 * 6419) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var20 < 16384 else 0) else (255 if (1 if var23 >= -8708 else 0) else 0)))
            var10 = ((((var10 * 26149) & 0xFFFFFFFF) >> 8) + var15)
            var9 = (((((var10 * 26149) & 0xFFFFFFFF) >> 8) + var15) - 14234)
            i32_store8(var9, ((((((((var10 * 26149) & 0xFFFFFFFF) >> 8) + var15) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var9 < 16384 else 0) else (255 if (1 if var10 >= 14234 else 0) else 0)))
            if var1:
                ...
                i32_store8(var10 + 2, ((((((((var9 * 19077) & 0xFFFFFFFF) >> 8) + (((((((var13 + var17) & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var17 < 16384 else 0) else (255 if (1 if var15 >= 17685 else 0) else 0)))
                ...
                i32_store8(var10, (((((var9 + ((((((var13 & 0xFFFFFFFF) >> 17) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var17 < 16384 else 0) else (255 if (1 if var15 >= 14234 else 0) else 0)))
                ...
                i32_store8(var10 + 1, (((((var9 - ((((var18 * 6419) & 0xFFFFFFFF) >> 8) + (((var13 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var10 >= -8708 else 0) else 0)))
                ...
                i32_store8(var10 + 2, ((((((((var13 * 19077) & 0xFFFFFFFF) >> 8) + (((((((var11 + var22) & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var15 < 16384 else 0) else (255 if (1 if var18 >= 17685 else 0) else 0)))
                ...
                i32_store8(var10 + 1, (((((var13 - ((((var21 * 6419) & 0xFFFFFFFF) >> 8) + ((((((var9 & 0xFFFFFFFF) >> 17) & 255) * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var18 < 16384 else 0) else (255 if (1 if var21 >= -8708 else 0) else 0)))
                var10 = (var13 + (((var9 * 26149) & 0xFFFFFFFF) >> 8))
                var13 = ((var13 + (((var9 * 26149) & 0xFFFFFFFF) >> 8)) - 14234)
                i32_store8(var10, (((((var13 + (((var9 * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var10 >= 14234 else 0) else 0)))
        ...
        i32_store8(var0 + 2, ((((((((var2 * 19077) & 0xFFFFFFFF) >> 8) + ((((((((var11 + (var12 * 3)) + 131074) & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var8 < 16384 else 0) else (255 if (1 if var6 >= 17685 else 0) else 0)))
        ...
        i32_store8(var0, (((((var2 + ((((((var4 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var8 < 16384 else 0) else (255 if (1 if var6 >= 14234 else 0) else 0)))
        var0 = (var2 - ((((var5 * 6419) & 0xFFFFFFFF) >> 8) + (((var4 * 13320) & 0xFFFFFFFF) >> 8)))
        var2 = ((var2 - ((((var5 * 6419) & 0xFFFFFFFF) >> 8) + (((var4 * 13320) & 0xFFFFFFFF) >> 8))) + 8708)
        i32_store8(var0 + 1, (((((var2 - ((((var5 * 6419) & 0xFFFFFFFF) >> 8) + (((var4 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var2 < 16384 else 0) else (255 if (1 if var0 >= -8708 else 0) else 0)))
        ...
        i32_store8(var0 + 2, ((((((((var1 * 19077) & 0xFFFFFFFF) >> 8) + ((((((((var12 + (var11 * 3)) + 131074) & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var5 < 16384 else 0) else (255 if (1 if var4 >= 17685 else 0) else 0)))
        ...
        i32_store8(var0, (((((var1 + ((((((var2 & 0xFFFFFFFF) >> 18) & 255) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var5 < 16384 else 0) else (255 if (1 if var4 >= 14234 else 0) else 0)))
        var0 = (var1 - ((((var3 * 6419) & 0xFFFFFFFF) >> 8) + (((var2 * 13320) & 0xFFFFFFFF) >> 8)))
        var1 = ((var1 - ((((var3 * 6419) & 0xFFFFFFFF) >> 8) + (((var2 * 13320) & 0xFFFFFFFF) >> 8))) + 8708)
        i32_store8(var0 + 1, (((((var1 - ((((var3 * 6419) & 0xFFFFFFFF) >> 8) + (((var2 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var1 < 16384 else 0) else (255 if (1 if var0 >= -8708 else 0) else 0)))
        return
    a_c()
