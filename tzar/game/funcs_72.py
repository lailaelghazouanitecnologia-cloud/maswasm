...
# $func1015
# ==========================================================
def func1015(var0, var1, var2, var3, var4, var5, var6, var7, var8):
    var9 = 0
    var10 = 0
    var11 = 0
    var12 = 0
    ...
    if var0:
        ...
        i32_store8(var6 + 2, ((((((((i32_load8_u(var0) * 19077) & 0xFFFFFFFF) >> 8) + ((((((((i32_load8_u(var4) | (i32_load8_u(var5) << 16)) + ((i32_load8_u(var2) | (i32_load8_u(var3) << 16)) * 3)) + 131074) & 0xFFFFFFFF) >> 18) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var17 >= 14234 else 0) else 0)))
        ...
        i32_store8(var6, (((((var10 + ((((((var11 & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var17 >= 17685 else 0) else 0)))
        ...
        if var1:
            ...
            i32_store8(var7 + 2, ((((((((i32_load8_u(var1) * 19077) & 0xFFFFFFFF) >> 8) + (((((((var9 + (var12 * 3)) + 131074) & 0xFFFFFFFF) >> 18) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var17 >= 14234 else 0) else 0)))
            var11 = (((var11 & 0xFFFFFFFF) >> 2) & 255)
            var17 = (var10 + ((((((var11 & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8))
            var13 = ((var10 + ((((((var11 & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685)
            i32_store8(var7, (((((var10 + ((((((var11 & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var13 < 16384 else 0) else (255 if (1 if var17 >= 17685 else 0) else 0)))
            var10 = (var10 - ((((var11 * 6419) & 0xFFFFFFFF) >> 8) + (((var15 * 13320) & 0xFFFFFFFF) >> 8)))
            var11 = ((var10 - ((((var11 * 6419) & 0xFFFFFFFF) >> 8) + (((var15 * 13320) & 0xFFFFFFFF) >> 8))) + 8708)
        ...
        while True:  # loop $label1
            ...
            i32_store8(var14, (((((((((((var21 & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8) + var16) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var23 < 16384 else 0) else (255 if (1 if var19 >= 17685 else 0) else 0)))
            ...
            var22 = ((((((var25 + ((var9 + var10) << 1)) & 0xFFFFFFFF) >> 3) + var11) & 0xFFFFFFFF) >> 17)
            var19 = ((((i32_load8_u((var0 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + (((((((((var25 + ((var9 + var10) << 1)) & 0xFFFFFFFF) >> 3) + var11) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8))
            var23 = (((((i32_load8_u((var0 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + (((((((((var25 + ((var9 + var10) << 1)) & 0xFFFFFFFF) >> 3) + var11) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8)) - 14234)
            i32_store8((var6 + (var15 * 6)) + 2, ((((((((i32_load8_u((var0 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + (((((((((var25 + ((var9 + var10) << 1)) & 0xFFFFFFFF) >> 3) + var11) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var23 < 16384 else 0) else (255 if (1 if var19 >= 14234 else 0) else 0)))
            var9 = (((var9 & 0xFFFFFFFF) >> 1) & 255)
            var22 = (var16 - ((((var22 * 13320) & 0xFFFFFFFF) >> 8) + ((((((var9 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8)))
            var19 = ((var16 - ((((var22 * 13320) & 0xFFFFFFFF) >> 8) + ((((((var9 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8))) + 8708)
            i32_store8(var14 + 1, (((((var16 - ((((var22 * 13320) & 0xFFFFFFFF) >> 8) + ((((((var9 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var19 < 16384 else 0) else (255 if (1 if var22 >= -8708 else 0) else 0)))
            var9 = ((((var9 * 33050) & 0xFFFFFFFF) >> 8) + var16)
            var14 = (((((var9 * 33050) & 0xFFFFFFFF) >> 8) + var16) - 17685)
            i32_store8(var14, ((((((((var9 * 33050) & 0xFFFFFFFF) >> 8) + var16) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var14 < 16384 else 0) else (255 if (1 if var9 >= 17685 else 0) else 0)))
            if var1:
                var9 = (var7 + var20)
                ...
                i32_store8((var7 + var20) + 2, ((((((((i32_load8_u((var1 + var18)) * 19077) & 0xFFFFFFFF) >> 8) + ((((((var12 + var25) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var20 < 16384 else 0) else (255 if (1 if var16 >= 14234 else 0) else 0)))
                ...
                i32_store8(var9, (((((var18 + ((((((var12 & 0xFFFFFFFF) >> 1) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var20 < 16384 else 0) else (255 if (1 if var16 >= 17685 else 0) else 0)))
                ...
                var13 = (var10 + var24)
                var18 = (((var10 + var24) & 0xFFFFFFFF) >> 17)
                var14 = ((((i32_load8_u((var1 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + ((((((var10 + var24) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8))
                var16 = (((((i32_load8_u((var1 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + ((((((var10 + var24) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8)) - 14234)
                i32_store8((var7 + var21) + 2, ((((((((i32_load8_u((var1 + var13)) * 19077) & 0xFFFFFFFF) >> 8) + ((((((var10 + var24) & 0xFFFFFFFF) >> 17) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var16 < 16384 else 0) else (255 if (1 if var14 >= 14234 else 0) else 0)))
                var13 = (((var13 & 0xFFFFFFFF) >> 1) & 255)
                var18 = (var12 - (((((((var13 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8) + (((var18 * 13320) & 0xFFFFFFFF) >> 8)))
                var14 = ((var12 - (((((((var13 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8) + (((var18 * 13320) & 0xFFFFFFFF) >> 8))) + 8708)
                i32_store8(var9 + 1, (((((var12 - (((((((var13 & 0xFFFFFFFF) >> 1) & 255) * 6419) & 0xFFFFFFFF) >> 8) + (((var18 * 13320) & 0xFFFFFFFF) >> 8))) + 8708) & 0xFFFFFFFF) >> 6) if (1 if var14 < 16384 else 0) else (255 if (1 if var18 >= -8708 else 0) else 0)))
                var9 = (var12 + (((var13 * 33050) & 0xFFFFFFFF) >> 8))
                var12 = ((var12 + (((var13 * 33050) & 0xFFFFFFFF) >> 8)) - 17685)
                i32_store8(var9, (((((var12 + (((var13 * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var12 < 16384 else 0) else (255 if (1 if var9 >= 17685 else 0) else 0)))
        ...
        i32_store8((var6 + (var17 * 3)) + 2, ((((((((i32_load8_u((var0 + var17)) * 19077) & 0xFFFFFFFF) >> 8) + (((((((var10 + (var11 * 3)) + 131074) & 0xFFFFFFFF) >> 18) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var8 < 16384 else 0) else (255 if (1 if var6 >= 14234 else 0) else 0)))
        ...
        i32_store8(var2, (((((var0 + ((((((var4 & 0xFFFFFFFF) >> 2) & 255) * 33050) & 0xFFFFFFFF) >> 8)) - 17685) & 0xFFFFFFFF) >> 6) if (1 if var8 < 16384 else 0) else (255 if (1 if var6 >= 17685 else 0) else 0)))
        ...
        i32_store8((var3 + var7) + 2, ((((((((i32_load8_u((var1 + var17)) * 19077) & 0xFFFFFFFF) >> 8) + (((((((var11 + (var10 * 3)) + 131074) & 0xFFFFFFFF) >> 18) * 26149) & 0xFFFFFFFF) >> 8)) - 14234) & 0xFFFFFFFF) >> 6) if (1 if var5 < 16384 else 0) else (255 if (1 if var4 >= 14234 else 0) else 0)))
